...
def guiMain(args=None):
    ...
    banGoldSkulltulasVar = IntVar()
    banGoldSkulltulasCheckbutton = Checkbutton(checkBoxFrame, text="Ban Gold Skulltula Rewards (they will only give rupees)", variable=banGoldSkulltulasVar)
    ...
    banGoldSkulltulasCheckbutton.pack(expand=True, anchor=W)
    ...
    def generateRom():
        ...
        guiargs.ban_gold_skulltulas = bool(banGoldSkulltulasVar.get())
    ...
    if args is not None:
        ...
        banGoldSkulltulasVar.set(int(args.ban_gold_skulltulas))
